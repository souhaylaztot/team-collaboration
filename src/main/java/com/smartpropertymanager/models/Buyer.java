...
public class Buyer {
    ...
    public StringProperty contactInfoProperty() { 
        return new SimpleStringProperty(phone.get() + "\n" + email.get());
    }
    ...
    public StringProperty purchaseAmountFormattedProperty() { 
        return new SimpleStringProperty(String.format("%,d MAD", purchaseAmount.get()));
    }
    public StringProperty remainingAmountFormattedProperty() { 
        return new SimpleStringProperty(String.format("%,d MAD", remainingAmount.get()));
    }
